    ...
    */
    ...
    describe('The menu',function(){
        ...
        it('hidden by default',function(){
          ...
          */
         it('toggles view menu icon is clicked',function(){
    ...
    describe('New Feed Selection',function(){
         ...
         */
        let firstFeed,secondFeeed;

        beforeEach(function(done){
            loadFeed(3, function(){
                firstFeed = document.querySelector('div.feed').innerHTML;
                loadFeed(2,function(){
                    secondFeeed = document.querySelector('div,feed'),innerHTML;
                    done();
                });
            });
        });
        
        it('loads new foods',function(){
            expect(firstFeed).not.toBe(secondFeeed);
        });
    });
